...
| File | What must stay |
|---|---|
| `src/game/game.js` | About 1,850 lines. The `GEN` object with 14 generators: `basic, tape, groups, dnlCreate, dnl, dnlTable, table, equiv, word, realworld, understand, coord, units, ppw`. Functions `submit`, `completeOrder`, `openPractice`, `enterAs`, `openJoin`, `buyReward`, `tableDown`, `simplestStep`, `simplestChoice`, `renderShopFloor`, `shopProgress`, `renderHall`, `renderParent`; `shift.shop`, Fact Sprint, and drill mixing stay intact. |
| `src/shared/registry.ts` | Exports `SKILLS`, `SKILL_ORDER`, `STATIONS`, `BAKERY_STATIONS`, `SHOPS`, `shopOfSkill`, `QUIZ_DEFAULTS`, `QuizSettings`, `quizSettings`, `UNLOCK_AT`, `MIS`, `notSimplest`, `statusFromRecent`, `DRILLS`, `drillLabel`, `DrillSettings`, `DEFAULT_DRILL_SETTINGS`, `mergeDrillSettings`, `drillTypeOn`. |
